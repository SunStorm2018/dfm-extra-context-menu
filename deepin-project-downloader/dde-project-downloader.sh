...
# 运行Python应用
# 检查是否在安装路径下运行
if [ -f /usr/share/dde-file-manager-extramenu-plugins/deepin-project-downloader-backen.py ]; then
    python3 /usr/share/dde-file-manager-extramenu-plugins/deepin-project-downloader-backen.py
else
